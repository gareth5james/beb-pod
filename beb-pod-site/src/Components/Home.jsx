function Home() {
    return <main>
        <p className="app__welcome">
            ...
            Founded in 1993, Bebington Podiatry offers professional, comprehensive and friendly private podiatry treatment to the highest industry standards at our purpose built clinic.<br/><br/>
            ...
            We offer all aspects of podiatry from:</p>
            ...
            <p>We are a covid safe business, still working to Covid-19 health & safety protocol as we are a small clinic and have many health-vulnerable patients<br/><br/>
